...
repository_url="$(terraform -chdir="${terraform_dir}" output -raw frontend_ecr_repository_url)"
repository_name="$(terraform -chdir="${terraform_dir}" output -raw frontend_ecr_repository_name)"
...
echo "FRONTEND_IMAGE_PUSHED"
echo "FRONTEND_IMAGE=${image_reference}"
