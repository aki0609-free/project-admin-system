...
export const toReportMasterForm = (
  ...
  sourceViewName: detail.sourceViewName ?? null,
  historyTable: detail.historyTable ?? null,
  htmlTemplateKey: detail.htmlTemplateKey ?? null,
  htmlTemplateVersion: detail.htmlTemplateVersion ?? null,
  htmlTemplateHash: detail.htmlTemplateHash ?? null,
...
export const toReportMasterSaveRequest = (
  ...
  sourceViewName: normalizeNullableString(form.sourceViewName),
  historyTable: normalizeNullableString(form.historyTable),
  htmlTemplateKey: normalizeNullableString(form.htmlTemplateKey),
  htmlTemplateVersion: form.htmlTemplateVersion,
  htmlTemplateHash: normalizeNullableString(form.htmlTemplateHash),
