...
(
    ...
    'SCRIPT',
    'health_insurance_rate_2026.csv',
    'PYTHON',
    'convert_health_insurance_rate.py',
    '--year 2026 --prefecture 22 --input /tmp/project-admin/source/kyoukaikenpo_shizuoka_2026.pdf --output ${IMPORT_CSV_DIR}/health_insurance_rate_2026.csv',
    'INSERT_ONLY',
    1,
    2,
    'UTF-8',
...
(
    ...
    'SCRIPT',
    'pension_insurance_rate_2026.csv',
    'PYTHON',
...
(
    ...
    'SCRIPT',
    'standard_monthly_remuneration_2026.csv',
    'PYTHON',
    'convert_standard_monthly_remuneration.py',
    '--year 2026 --input /tmp/project-admin/source/social_insurance_2026.pdf --output ${IMPORT_CSV_DIR}/standard_monthly_remuneration_2026.csv',
    'INSERT_ONLY',
    1,
    2,
    'UTF-8',
...
(
    ...
    'SCRIPT',
    'child_care_support_fund_2026.csv',
    'PYTHON',
    'convert_child_care_support_fund.py',
    '--year 2026 --input /tmp/project-admin/source/social_insurance_2026.pdf --output ${IMPORT_CSV_DIR}/child_care_support_fund_2026.csv',
    'INSERT_ONLY',
    1,
    2,
    'UTF-8',
...
SET
    ...
    script_args = '--year 2026 --input /tmp/project-admin/source/kyoukaikenpo_shizuoka_2026.pdf --output ${IMPORT_CSV_DIR}/health_insurance_rate_2026.csv'
